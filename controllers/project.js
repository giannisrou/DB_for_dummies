...
exports.postUpdateProj = (req, res, next) => {
    ...
    const end_date = req.body.end_end;
    ...
    pool.getConnection((err, conn) => {
        var sqlQuery = `UPDATE organizations SET description = '${description}', funds='${funds}', start_date='${start_date}', 
        ...
        org_name = '${org_name}', prog_name = '${prog_name}'`;
