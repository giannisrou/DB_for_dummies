...
exports.postDeleteOrg = (req, res, next) => {
    /* get id from params */
    const name = req.params.org_name;
    
    /* create the connection, execute query and redirect to organization route */
    pool.getConnection((err, conn) => {
        var sqlQuery = `DELETE FROM organizations WHERE Org_Name = ${name}`;
